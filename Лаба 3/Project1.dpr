...
begin
  ...
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   1   - добавить термин/подтермин                                  |'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   2  - добавить страницу к термину'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   3   - удалить термин'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   4  - удалить страницу'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   5  - изменить термин'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   6 - изменить страницу'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   7  - поиск термина/подтермина'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   8 - вывести предметный указатель отсортированный по алфавиту'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   9 - вывести  предметный указатель отсортированный по страницам'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   10 - вывести содержимое предметного указателя'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   11  - показать справочник команд'));
  Writeln('-----------------------------------------------------------------------');
  Writeln(RusWR('   0  - выпиливаемся'));
  Writeln('-----------------------------------------------------------------------');
end;
...
begin
  ...
  AddTerm(Terms,GetTPT(('шкаф'),GetPPT(250)));
  AddPage(Terms[H(('шкаф'))]^.Next^.Pages,GetPPT(252));
  AddPage(Terms[H(('шкаф'))]^.Next^.Pages,GetPPT(870));
  AddPage(Terms[H(('шкаф'))]^.Next^.Pages,GetPPT(963));

  AddTerm(Terms[H(('шкаф'))]^.Next^.SubTerm,GetTPT('новый',GetPPT(542)));
  AddTerm(Terms[H(('шкаф'))]^.Next^.SubTerm,GetTPT('старый',GetPPT(987)));
  AddTerm(Terms[H(('шкаф'))]^.Next^.SubTerm,GetTPT('серо-буро-малиновый',GetPPT(570)));
  AddTerm( FindTerm(GetTPT('серо-буро-малиновый',nil))^.Next^.Result^.SubTerm, GetTPT(('деревяный'),GetPPT(100)));
  ...
  begin
    ...
    begin
      Write(RusWR('Введите надтермин добавляемого термина (просто Enter, если хотите добавить термин: '));
      Readln(upterm);
      upterm:=RusRD(upterm);
